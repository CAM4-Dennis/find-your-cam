...
// ─── Load combo content cache (generated by export-combo-content.mjs) ────
let comboContentCache = { genderCategory: {}, platformCategory: {}, languageSpeaking: {} };
try {
  comboContentCache = JSON.parse(readFileSync(join(__dirname, ".combo-content-cache.json"), "utf-8"));
} catch { /* no combo content cache available */ }
...
const countryOutroData = {
  "nederlandse-cam-girls": { nl: ["Nederlandse", "Nederland"], en: ["Dutch", "the Netherlands"], fr: ["néerlandaises", "les Pays-Bas"], de: ["Niederländische", "den Niederlanden"], es: ["holandesas", "los Países Bajos"], it: ["olandesi", "i Paesi Bassi"] },
  "belgische-cam-girls": { nl: ["Belgische", "België"], en: ["Belgian", "Belgium"], fr: ["belges", "la Belgique"], de: ["Belgische", "Belgien"], es: ["belgas", "Bélgica"], it: ["belghe", "il Belgio"] },
  "duitse-cam-girls": { nl: ["Duitse", "Duitsland"], en: ["German", "Germany"], fr: ["allemandes", "l'Allemagne"], de: ["Deutsche", "Deutschland"], es: ["alemanas", "Alemania"], it: ["tedesche", "la Germania"] },
  "colombiaanse-cam-girls": { nl: ["Colombiaanse", "Colombia"], en: ["Colombian", "Colombia"], fr: ["colombiennes", "la Colombie"], de: ["Kolumbianische", "Kolumbien"], es: ["colombianas", "Colombia"], it: ["colombiane", "la Colombia"] },
  "roemeense-cam-girls": { nl: ["Roemeense", "Roemenië"], en: ["Romanian", "Romania"], fr: ["roumaines", "la Roumanie"], de: ["Rumänische", "Rumänien"], es: ["rumanas", "Rumanía"], it: ["rumene", "la Romania"] },
  "italiaanse-cam-girls": { nl: ["Italiaanse", "Italië"], en: ["Italian", "Italy"], fr: ["italiennes", "l'Italie"], de: ["Italienische", "Italien"], es: ["italianas", "Italia"], it: ["italiane", "l'Italia"] },
  "spaanse-cam-girls": { nl: ["Spaanse", "Spanje"], en: ["Spanish", "Spain"], fr: ["espagnoles", "l'Espagne"], de: ["Spanische", "Spanien"], es: ["españolas", "España"], it: ["spagnole", "la Spagna"] },
  "franse-cam-girls": { nl: ["Franse", "Frankrijk"], en: ["French", "France"], fr: ["françaises", "la France"], de: ["Französische", "Frankreich"], es: ["francesas", "Francia"], it: ["francesi", "la Francia"] },
  "britse-cam-girls": { nl: ["Britse", "het Verenigd Koninkrijk"], en: ["British", "the United Kingdom"], fr: ["britanniques", "le Royaume-Uni"], de: ["Britische", "dem Vereinigten Königreich"], es: ["británicas", "el Reino Unido"], it: ["britanniche", "il Regno Unito"] },
  "amerikaanse-cam-girls": { nl: ["Amerikaanse", "de Verenigde Staten"], en: ["American", "the United States"], fr: ["américaines", "les États-Unis"], de: ["Amerikanische", "den USA"], es: ["americanas", "los Estados Unidos"], it: ["americane", "gli Stati Uniti"] },
  "russische-cam-girls": { nl: ["Russische", "Rusland"], en: ["Russian", "Russia"], fr: ["russes", "la Russie"], de: ["Russische", "Russland"], es: ["rusas", "Rusia"], it: ["russe", "la Russia"] },
  "oekraiense-cam-girls": { nl: ["Oekraïense", "Oekraïne"], en: ["Ukrainian", "Ukraine"], fr: ["ukrainiennes", "l'Ukraine"], de: ["Ukrainische", "der Ukraine"], es: ["ucranianas", "Ucrania"], it: ["ucraine", "l'Ucraina"] },
  "braziliaanse-cam-girls": { nl: ["Braziliaanse", "Brazilië"], en: ["Brazilian", "Brazil"], fr: ["brésiliennes", "le Brésil"], de: ["Brasilianische", "Brasilien"], es: ["brasileñas", "Brasil"], it: ["brasiliane", "il Brasile"] },
  "japanse-cam-girls": { nl: ["Japanse", "Japan"], en: ["Japanese", "Japan"], fr: ["japonaises", "le Japon"], de: ["Japanische", "Japan"], es: ["japonesas", "Japón"], it: ["giapponesi", "il Giappone"] },
  "poolse-cam-girls": { nl: ["Poolse", "Polen"], en: ["Polish", "Poland"], fr: ["polonaises", "la Pologne"], de: ["Polnische", "Polen"], es: ["polacas", "Polonia"], it: ["polacche", "la Polonia"] },
  "mexicaanse-cam-girls": { nl: ["Mexicaanse", "Mexico"], en: ["Mexican", "Mexico"], fr: ["mexicaines", "le Mexique"], de: ["Mexikanische", "Mexiko"], es: ["mexicanas", "México"], it: ["messicane", "il Messico"] },
...
const categoryOutroNames = {
  "jonge-cam-girls-18-plus": { nl: "Teen 18+", en: "Teen 18+", fr: "Teen 18+", de: "Teen 18+", es: "Teen 18+", it: "Teen 18+" },
  "milf-webcamsex-ervaren-vrouwen": { nl: "MILF", en: "MILF", fr: "MILF", de: "MILF", es: "MILF", it: "MILF" },
  "mature-webcamsex-oudere-vrouwen": { nl: "Mature", en: "Mature", fr: "Mature", de: "Mature", es: "Mature", it: "Mature" },
  "aziatische-cam-girls-live": { nl: "Aziatisch", en: "Asian", fr: "Asiatique", de: "Asiatisch", es: "Asiáticas", it: "Asiatiche" },
  "latina-cam-girls-live": { nl: "Latina", en: "Latina", fr: "Latina", de: "Latina", es: "Latina", it: "Latina" },
  "ebony-cam-girls-live": { nl: "Ebony", en: "Ebony", fr: "Ebony", de: "Ebony", es: "Ebony", it: "Ebony" },
  "cam-girls-grote-borsten": { nl: "Grote Borsten", en: "Big Boobs", fr: "Gros Seins", de: "Große Brüste", es: "Tetas Grandes", it: "Tette Grandi" },
  "petite-cam-girls-kleine-borsten": { nl: "Kleine Borsten", en: "Small Tits", fr: "Petits Seins", de: "Kleine Brüste", es: "Tetas Pequeñas", it: "Tette Piccole" },
  "anale-cam-shows-live": { nl: "Anal", en: "Anal", fr: "Anal", de: "Anal", es: "Anal", it: "Anale" },
  "cam-koppels-live-sex": { nl: "Koppels", en: "Couples", fr: "Couples", de: "Paare", es: "Parejas", it: "Coppie" },
  "squirt-cam-shows-live": { nl: "Squirt", en: "Squirt", fr: "Squirt", de: "Squirt", es: "Squirt", it: "Squirt" },
  "bdsm-bondage-cam-shows": { nl: "BDSM", en: "BDSM", fr: "BDSM", de: "BDSM", es: "BDSM", it: "BDSM" },
  "getatoeeerde-cam-girls": { nl: "Tattoo", en: "Tattoo", fr: "Tatouage", de: "Tattoo", es: "Tatuaje", it: "Tatuaggio" },
  "behaarde-cam-girls-natural": { nl: "Hairy", en: "Hairy", fr: "Poilu", de: "Behaart", es: "Peluda", it: "Pelosa" },
...
// 8. Gender × Category pages (NL + EN only)
const comboLangs = ["nl", "en"];
const comboLangPrefixes = { nl: "", en: "/en" };

for (const [comboKey, langData] of Object.entries(comboContentCache.genderCategory)) {
  const [genderSlug, catSlug] = comboKey.split("/");
  for (const lang of comboLangs) {
    const content = langData[lang];
    if (!content) continue;
    const prefix = comboLangPrefixes[lang];
    const baseSlug = `${genderSlug}/${catSlug}`;
    ...
    const bodyHtml = `<p>${renderContent(content.intro)}</p>${sectionsHtml}`;
    if (processPage(fullSlug, lang, esc(content.h1), bodyHtml, content.faq || [])) count++;
  }
}

// 9. Platform × Category pages (NL + EN only)
for (const [comboKey, langData] of Object.entries(comboContentCache.platformCategory)) {
  const [platformSlug, catSlug] = comboKey.split("/");
  for (const lang of comboLangs) {
    const content = langData[lang];
    if (!content) continue;
    const prefix = comboLangPrefixes[lang];
...
// 10. Language-speaking pages (NL + EN only)
for (const [slug, langData] of Object.entries(comboContentCache.languageSpeaking)) {
  for (const lang of comboLangs) {
    const content = langData[lang];
    if (!content) continue;
    const prefix = comboLangPrefixes[lang];
