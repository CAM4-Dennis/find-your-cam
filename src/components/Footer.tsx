...
function getFooterContent(path: string): { title: string; paragraphs: ReactNode[] } {
  ...
  if (path.startsWith("/live-sex-cams-")) {
    const name = path.includes("chaturbate") ? "Chaturbate" : path.includes("stripchat") ? "Stripchat" : path.includes("bongacams") ? "BongaCams" : path.includes("jerkmate") ? "Jerkmate" : path.includes("cam4") ? "CAM4" : "CAM4";
    const others = ["Chaturbate", "Stripchat", "BongaCams", "CAM4", "Jerkmate"].filter(p => p !== name);
    return {
  ...
  if (path.startsWith("/chaturbate/") || path.startsWith("/bongacams/") ||
    ...
    const platformMap: Record<string, string> = { chaturbate: "Chaturbate", bongacams: "BongaCams", cam4: "CAM4", stripchat: "Stripchat", jerkmate: "Jerkmate", };
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to={localePath("/webcamsex-milf")} className="hover:text-primary transition-colors">{t.catMilf}</Link></li>
              <li><Link to={localePath("/webcamsex-teen-18-plus")} className="hover:text-primary transition-colors">{t.catTeen18}</Link></li>
              <li><Link to={localePath("/webcamsex-koppels")} className="hover:text-primary transition-colors">{t.catCouples}</Link></li>
              <li><Link to={localePath("/webcamsex-anal")} className="hover:text-primary transition-colors">{t.catAnal}</Link></li>
              <li><Link to={localePath("/webcamsex-grote-borsten")} className="hover:text-primary transition-colors">{t.catBigBoobs}</Link></li>
              <li><Link to={localePath("/webcamsex-latina")} className="hover:text-primary transition-colors">{t.catLatina}</Link></li>
              <li><Link to={localePath("/categories")} className="hover:text-primary transition-colors font-medium">{t.footerAllCategories}</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to={localePath("/webcamsex-belgie")} className="hover:text-primary transition-colors">🇧🇪 België</Link></li>
              <li><Link to={localePath("/webcamsex-colombia")} className="hover:text-primary transition-colors">🇨🇴 Colombia</Link></li>
              <li><Link to={localePath("/countries")} className="hover:text-primary transition-colors font-medium">{t.footerAllCountries}</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-sm mb-3 text-foreground">{t.footerDiscover}</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to={localePath("/new")} className="hover:text-primary transition-colors">{t.footerNewCamGirls}</Link></li>
              <li><Link to={localePath("/top")} className="hover:text-primary transition-colors">Top Cams</Link></li>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to={localePath("/languages")} className="hover:text-primary transition-colors font-medium">{t.footerAllLanguages}</Link></li>
            </ul>
          </div>
        </div>
