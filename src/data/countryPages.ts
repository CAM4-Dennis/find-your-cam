...
const remainingCountries: Array<{slug: string; flag: string; nl: string; en: string; fr: string; de: string; es: string; it: string; nlA: string; enA: string; frA: string; deA: string; esA: string; itA: string; platform: string}> = [
  ...
  // --- NEW COUNTRIES (Fase 2) ---
  // Tier 1: Top cam-landen
  { slug: "canadese-cam-girls", flag: "🇨🇦", nl: "Canada", en: "Canada", fr: "Canada", de: "Kanada", es: "Canadá", it: "Canada", nlA: "Canadese", enA: "Canadian", frA: "canadiennes", deA: "kanadische", esA: "canadienses", itA: "canadesi", platform: "Chaturbate en Stripchat" },
  { slug: "australische-cam-girls", flag: "🇦🇺", nl: "Australië", en: "Australia", fr: "Australie", de: "Australien", es: "Australia", it: "Australia", nlA: "Australische", enA: "Australian", frA: "australiennes", deA: "australische", esA: "australianas", itA: "australiane", platform: "Chaturbate en Stripchat" },
  { slug: "hongaarse-cam-girls", flag: "🇭🇺", nl: "Hongarije", en: "Hungary", fr: "Hongrie", de: "Ungarn", es: "Hungría", it: "Ungheria", nlA: "Hongaarse", enA: "Hungarian", frA: "hongroises", deA: "ungarische", esA: "húngaras", itA: "ungheresi", platform: "BongaCams en Stripchat" },
  { slug: "argentijnse-cam-girls", flag: "🇦🇷", nl: "Argentinië", en: "Argentina", fr: "Argentine", de: "Argentinien", es: "Argentina", it: "Argentina", nlA: "Argentijnse", enA: "Argentinian", frA: "argentines", deA: "argentinische", esA: "argentinas", itA: "argentine", platform: "Chaturbate en Stripchat" },
  { slug: "indiase-cam-girls", flag: "🇮🇳", nl: "India", en: "India", fr: "Inde", de: "Indien", es: "India", it: "India", nlA: "Indiase", enA: "Indian", frA: "indiennes", deA: "indische", esA: "indias", itA: "indiane", platform: "Stripchat en Chaturbate" },
  { slug: "turkse-cam-girls", flag: "🇹🇷", nl: "Turkije", en: "Turkey", fr: "Turquie", de: "Türkei", es: "Turquía", it: "Turchia", nlA: "Turkse", enA: "Turkish", frA: "turques", deA: "türkische", esA: "turcas", itA: "turche", platform: "Stripchat en BongaCams" },
  { slug: "griekse-cam-girls", flag: "🇬🇷", nl: "Griekenland", en: "Greece", fr: "Grèce", de: "Griechenland", es: "Grecia", it: "Grecia", nlA: "Griekse", enA: "Greek", frA: "grecques", deA: "griechische", esA: "griegas", itA: "greche", platform: "Stripchat en Chaturbate" },
  { slug: "portugese-cam-girls", flag: "🇵🇹", nl: "Portugal", en: "Portugal", fr: "Portugal", de: "Portugal", es: "Portugal", it: "Portogallo", nlA: "Portugese", enA: "Portuguese", frA: "portugaises", deA: "portugiesische", esA: "portuguesas", itA: "portoghesi", platform: "Chaturbate en XCams" },
  { slug: "kroatische-cam-girls", flag: "🇭🇷", nl: "Kroatië", en: "Croatia", fr: "Croatie", de: "Kroatien", es: "Croacia", it: "Croazia", nlA: "Kroatische", enA: "Croatian", frA: "croates", deA: "kroatische", esA: "croatas", itA: "croate", platform: "BongaCams en Stripchat" },
  { slug: "servische-cam-girls", flag: "🇷🇸", nl: "Servië", en: "Serbia", fr: "Serbie", de: "Serbien", es: "Serbia", it: "Serbia", nlA: "Servische", enA: "Serbian", frA: "serbes", deA: "serbische", esA: "serbias", itA: "serbe", platform: "BongaCams en Stripchat" },
  { slug: "bulgaarse-cam-girls", flag: "🇧🇬", nl: "Bulgarije", en: "Bulgaria", fr: "Bulgarie", de: "Bulgarien", es: "Bulgaria", it: "Bulgaria", nlA: "Bulgaarse", enA: "Bulgarian", frA: "bulgares", deA: "bulgarische", esA: "búlgaras", itA: "bulgare", platform: "BongaCams en Stripchat" },
  { slug: "letse-cam-girls", flag: "🇱🇻", nl: "Letland", en: "Latvia", fr: "Lettonie", de: "Lettland", es: "Letonia", it: "Lettonia", nlA: "Letse", enA: "Latvian", frA: "lettonnes", deA: "lettische", esA: "letonas", itA: "lettoni", platform: "BongaCams en Stripchat" },
  { slug: "litouwse-cam-girls", flag: "🇱🇹", nl: "Litouwen", en: "Lithuania", fr: "Lituanie", de: "Litauen", es: "Lituania", it: "Lituania", nlA: "Litouwse", enA: "Lithuanian", frA: "lituaniennes", deA: "litauische", esA: "lituanas", itA: "lituane", platform: "BongaCams en Stripchat" },
  { slug: "estse-cam-girls", flag: "🇪🇪", nl: "Estland", en: "Estonia", fr: "Estonie", de: "Estland", es: "Estonia", it: "Estonia", nlA: "Estse", enA: "Estonian", frA: "estoniennes", deA: "estnische", esA: "estonias", itA: "estoni", platform: "BongaCams en Stripchat" },
  { slug: "slowaakse-cam-girls", flag: "🇸🇰", nl: "Slowakije", en: "Slovakia", fr: "Slovaquie", de: "Slowakei", es: "Eslovaquia", it: "Slovacchia", nlA: "Slowaakse", enA: "Slovak", frA: "slovaques", deA: "slowakische", esA: "eslovacas", itA: "slovacche", platform: "BongaCams en Stripchat" },
  // Tier 2: Middelgrote landen
  { slug: "zweedse-cam-girls", flag: "🇸🇪", nl: "Zweden", en: "Sweden", fr: "Suède", de: "Schweden", es: "Suecia", it: "Svezia", nlA: "Zweedse", enA: "Swedish", frA: "suédoises", deA: "schwedische", esA: "suecas", itA: "svedesi", platform: "Chaturbate en Stripchat" },
  { slug: "noorse-cam-girls", flag: "🇳🇴", nl: "Noorwegen", en: "Norway", fr: "Norvège", de: "Norwegen", es: "Noruega", it: "Norvegia", nlA: "Noorse", enA: "Norwegian", frA: "norvégiennes", deA: "norwegische", esA: "noruegas", itA: "norvegesi", platform: "Chaturbate en Stripchat" },
  { slug: "deense-cam-girls", flag: "🇩🇰", nl: "Denemarken", en: "Denmark", fr: "Danemark", de: "Dänemark", es: "Dinamarca", it: "Danimarca", nlA: "Deense", enA: "Danish", frA: "danoises", deA: "dänische", esA: "danesas", itA: "danesi", platform: "Chaturbate en Stripchat" },
  { slug: "finse-cam-girls", flag: "🇫🇮", nl: "Finland", en: "Finland", fr: "Finlande", de: "Finnland", es: "Finlandia", it: "Finlandia", nlA: "Finse", enA: "Finnish", frA: "finlandaises", deA: "finnische", esA: "finlandesas", itA: "finlandesi", platform: "Chaturbate en Stripchat" },
  { slug: "oostenrijkse-cam-girls", flag: "🇦🇹", nl: "Oostenrijk", en: "Austria", fr: "Autriche", de: "Österreich", es: "Austria", it: "Austria", nlA: "Oostenrijkse", enA: "Austrian", frA: "autrichiennes", deA: "österreichische", esA: "austríacas", itA: "austriache", platform: "Stripchat en BongaCams" },
  { slug: "zwitserse-cam-girls", flag: "🇨🇭", nl: "Zwitserland", en: "Switzerland", fr: "Suisse", de: "Schweiz", es: "Suiza", it: "Svizzera", nlA: "Zwitserse", enA: "Swiss", frA: "suisses", deA: "schweizerische", esA: "suizas", itA: "svizzere", platform: "XCams en Stripchat" },
  { slug: "ierse-cam-girls", flag: "🇮🇪", nl: "Ierland", en: "Ireland", fr: "Irlande", de: "Irland", es: "Irlanda", it: "Irlanda", nlA: "Ierse", enA: "Irish", frA: "irlandaises", deA: "irische", esA: "irlandesas", itA: "irlandesi", platform: "Chaturbate en Stripchat" },
  { slug: "zuidafrikaanse-cam-girls", flag: "🇿🇦", nl: "Zuid-Afrika", en: "South Africa", fr: "Afrique du Sud", de: "Südafrika", es: "Sudáfrica", it: "Sudafrica", nlA: "Zuid-Afrikaanse", enA: "South African", frA: "sud-africaines", deA: "südafrikanische", esA: "sudafricanas", itA: "sudafricane", platform: "Chaturbate en Stripchat" },
  { slug: "israelische-cam-girls", flag: "🇮🇱", nl: "Israël", en: "Israel", fr: "Israël", de: "Israel", es: "Israel", it: "Israele", nlA: "Israëlische", enA: "Israeli", frA: "israéliennes", deA: "israelische", esA: "israelíes", itA: "israeliane", platform: "Chaturbate en Stripchat" },
  { slug: "egyptische-cam-girls", flag: "🇪🇬", nl: "Egypte", en: "Egypt", fr: "Égypte", de: "Ägypten", es: "Egipto", it: "Egitto", nlA: "Egyptische", enA: "Egyptian", frA: "égyptiennes", deA: "ägyptische", esA: "egipcias", itA: "egiziane", platform: "Stripchat en Chaturbate" },
  { slug: "marokkaanse-cam-girls", flag: "🇲🇦", nl: "Marokko", en: "Morocco", fr: "Maroc", de: "Marokko", es: "Marruecos", it: "Marocco", nlA: "Marokkaanse", enA: "Moroccan", frA: "marocaines", deA: "marokkanische", esA: "marroquíes", itA: "marocchine", platform: "Stripchat en Chaturbate" },
  { slug: "nigeriaanse-cam-girls", flag: "🇳🇬", nl: "Nigeria", en: "Nigeria", fr: "Nigeria", de: "Nigeria", es: "Nigeria", it: "Nigeria", nlA: "Nigeriaanse", enA: "Nigerian", frA: "nigérianes", deA: "nigerianische", esA: "nigerianas", itA: "nigeriane", platform: "Chaturbate en Stripchat" },
  { slug: "keniaanse-cam-girls", flag: "🇰🇪", nl: "Kenia", en: "Kenya", fr: "Kenya", de: "Kenia", es: "Kenia", it: "Kenya", nlA: "Keniaanse", enA: "Kenyan", frA: "kényanes", deA: "kenianische", esA: "kenianas", itA: "keniane", platform: "Chaturbate en Stripchat" },
  { slug: "venezolaanse-cam-girls", flag: "🇻🇪", nl: "Venezuela", en: "Venezuela", fr: "Venezuela", de: "Venezuela", es: "Venezuela", it: "Venezuela", nlA: "Venezolaanse", enA: "Venezuelan", frA: "vénézuéliennes", deA: "venezolanische", esA: "venezolanas", itA: "venezuelane", platform: "Chaturbate en Stripchat" },
  { slug: "peruaanse-cam-girls", flag: "🇵🇪", nl: "Peru", en: "Peru", fr: "Pérou", de: "Peru", es: "Perú", it: "Perù", nlA: "Peruaanse", enA: "Peruvian", frA: "péruviennes", deA: "peruanische", esA: "peruanas", itA: "peruviane", platform: "Chaturbate en Stripchat" },
  { slug: "chileense-cam-girls", flag: "🇨🇱", nl: "Chili", en: "Chile", fr: "Chili", de: "Chile", es: "Chile", it: "Cile", nlA: "Chileense", enA: "Chilean", frA: "chiliennes", deA: "chilenische", esA: "chilenas", itA: "cilene", platform: "Chaturbate en Stripchat" },
  { slug: "ecuadoriaanse-cam-girls", flag: "🇪🇨", nl: "Ecuador", en: "Ecuador", fr: "Équateur", de: "Ecuador", es: "Ecuador", it: "Ecuador", nlA: "Ecuadoriaanse", enA: "Ecuadorian", frA: "équatoriennes", deA: "ecuadorianische", esA: "ecuatorianas", itA: "ecuadoriane", platform: "Chaturbate en Stripchat" },
  { slug: "dominicaanse-cam-girls", flag: "🇩🇴", nl: "Dominicaanse Republiek", en: "Dominican Republic", fr: "République dominicaine", de: "Dominikanische Republik", es: "República Dominicana", it: "Repubblica Dominicana", nlA: "Dominicaanse", enA: "Dominican", frA: "dominicaines", deA: "dominikanische", esA: "dominicanas", itA: "dominicane", platform: "Chaturbate en Stripchat" },
  { slug: "cubaanse-cam-girls", flag: "🇨🇺", nl: "Cuba", en: "Cuba", fr: "Cuba", de: "Kuba", es: "Cuba", it: "Cuba", nlA: "Cubaanse", enA: "Cuban", frA: "cubaines", deA: "kubanische", esA: "cubanas", itA: "cubane", platform: "Chaturbate en Stripchat" },
  // Tier 3: Aziatisch/Pacific
  { slug: "koreaanse-cam-girls", flag: "🇰🇷", nl: "Zuid-Korea", en: "South Korea", fr: "Corée du Sud", de: "Südkorea", es: "Corea del Sur", it: "Corea del Sud", nlA: "Koreaanse", enA: "Korean", frA: "coréennes", deA: "koreanische", esA: "coreanas", itA: "coreane", platform: "Stripchat en Chaturbate" },
  { slug: "chinese-cam-girls", flag: "🇨🇳", nl: "China", en: "China", fr: "Chine", de: "China", es: "China", it: "Cina", nlA: "Chinese", enA: "Chinese", frA: "chinoises", deA: "chinesische", esA: "chinas", itA: "cinesi", platform: "Stripchat en Chaturbate" },
  { slug: "indonesische-cam-girls", flag: "🇮🇩", nl: "Indonesië", en: "Indonesia", fr: "Indonésie", de: "Indonesien", es: "Indonesia", it: "Indonesia", nlA: "Indonesische", enA: "Indonesian", frA: "indonésiennes", deA: "indonesische", esA: "indonesias", itA: "indonesiane", platform: "Chaturbate en Stripchat" },
  { slug: "vietnamese-cam-girls", flag: "🇻🇳", nl: "Vietnam", en: "Vietnam", fr: "Vietnam", de: "Vietnam", es: "Vietnam", it: "Vietnam", nlA: "Vietnamese", enA: "Vietnamese", frA: "vietnamiennes", deA: "vietnamesische", esA: "vietnamitas", itA: "vietnamite", platform: "Chaturbate en Stripchat" },
  { slug: "maleisische-cam-girls", flag: "🇲🇾", nl: "Maleisië", en: "Malaysia", fr: "Malaisie", de: "Malaysia", es: "Malasia", it: "Malesia", nlA: "Maleisische", enA: "Malaysian", frA: "malaisiennes", deA: "malaysische", esA: "malasias", itA: "malesi", platform: "Chaturbate en Stripchat" },
  { slug: "taiwanese-cam-girls", flag: "🇹🇼", nl: "Taiwan", en: "Taiwan", fr: "Taïwan", de: "Taiwan", es: "Taiwán", it: "Taiwan", nlA: "Taiwanese", enA: "Taiwanese", frA: "taïwanaises", deA: "taiwanische", esA: "taiwanesas", itA: "taiwanesi", platform: "Stripchat en Chaturbate" },
  { slug: "singaporese-cam-girls", flag: "🇸🇬", nl: "Singapore", en: "Singapore", fr: "Singapour", de: "Singapur", es: "Singapur", it: "Singapore", nlA: "Singaporese", enA: "Singaporean", frA: "singapouriennes", deA: "singapurische", esA: "singapurenses", itA: "singaporiane", platform: "Chaturbate en Stripchat" },
  // Tier 4: Extra Europees
  { slug: "moldavische-cam-girls", flag: "🇲🇩", nl: "Moldavië", en: "Moldova", fr: "Moldavie", de: "Moldawien", es: "Moldavia", it: "Moldavia", nlA: "Moldavische", enA: "Moldovan", frA: "moldaves", deA: "moldawische", esA: "moldavas", itA: "moldave", platform: "BongaCams en Stripchat" },
  { slug: "albanese-cam-girls", flag: "🇦🇱", nl: "Albanië", en: "Albania", fr: "Albanie", de: "Albanien", es: "Albania", it: "Albania", nlA: "Albanese", enA: "Albanian", frA: "albanaises", deA: "albanische", esA: "albanesas", itA: "albanesi", platform: "Stripchat en Chaturbate" },
  { slug: "sloveense-cam-girls", flag: "🇸🇮", nl: "Slovenië", en: "Slovenia", fr: "Slovénie", de: "Slowenien", es: "Eslovenia", it: "Slovenia", nlA: "Sloveense", enA: "Slovenian", frA: "slovènes", deA: "slowenische", esA: "eslovenas", itA: "slovene", platform: "BongaCams en Stripchat" },
  { slug: "bosnische-cam-girls", flag: "🇧🇦", nl: "Bosnië", en: "Bosnia", fr: "Bosnie", de: "Bosnien", es: "Bosnia", it: "Bosnia", nlA: "Bosnische", enA: "Bosnian", frA: "bosniaques", deA: "bosnische", esA: "bosnias", itA: "bosniache", platform: "BongaCams en Stripchat" },
  { slug: "georgische-cam-girls", flag: "🇬🇪", nl: "Georgië", en: "Georgia", fr: "Géorgie", de: "Georgien", es: "Georgia", it: "Georgia", nlA: "Georgische", enA: "Georgian", frA: "géorgiennes", deA: "georgische", esA: "georgianas", itA: "georgiane", platform: "BongaCams en Stripchat" },
  { slug: "armeense-cam-girls", flag: "🇦🇲", nl: "Armenië", en: "Armenia", fr: "Arménie", de: "Armenien", es: "Armenia", it: "Armenia", nlA: "Armeense", enA: "Armenian", frA: "arméniennes", deA: "armenische", esA: "armenias", itA: "armene", platform: "BongaCams en Stripchat" },
  { slug: "cypriotische-cam-girls", flag: "🇨🇾", nl: "Cyprus", en: "Cyprus", fr: "Chypre", de: "Zypern", es: "Chipre", it: "Cipro", nlA: "Cypriotische", enA: "Cypriot", frA: "chypriotes", deA: "zyprische", esA: "chipriotas", itA: "cipriote", platform: "Stripchat en Chaturbate" },
  { slug: "ijslandse-cam-girls", flag: "🇮🇸", nl: "IJsland", en: "Iceland", fr: "Islande", de: "Island", es: "Islandia", it: "Islanda", nlA: "IJslandse", enA: "Icelandic", frA: "islandaises", deA: "isländische", esA: "islandesas", itA: "islandesi", platform: "Chaturbate" },
];
