...
/** Common translated UI labels used across landing pages */
export const landingUI: Record<string, Record<Language, string>> = {
  ...
  moreCategories: { nl: "Meer categorieën op StartVagina", en: "More categories on StartVagina", fr: "Plus de catégories sur StartVagina", de: "Mehr Kategorien auf StartVagina", es: "Más categorías en StartVagina", it: "Altre categorie su StartVagina" },
  ...
  liveSexCams: { nl: "Live Sex Cams", en: "Live Sex Cams", fr: "Cams en Direct", de: "Live Sex Cams", es: "Cams en Vivo", it: "Cam dal Vivo" },
};
