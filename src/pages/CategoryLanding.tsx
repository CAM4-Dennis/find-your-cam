      ...
      <div className="min-h-screen flex flex-col bg-background">
        <Helmet>
          ...
          <script type="application/ld+json">
            {JSON.stringify(breadcrumbSchema([
              ...
              { name: landingUI.allCategories[lang], url: canonicalUrl("categorieen", lang) },
              { name: config.label, url: canonicalUrl(config.slug, lang) },
            ]))}
          </script>
        </Helmet>
        ...
        <main className="container flex-1 py-8">
          ...
          <nav aria-label="breadcrumb" className="mb-4 text-sm text-muted-foreground flex items-center gap-1 flex-wrap">
            ...
            <LocalLink to="/categorieen" className="hover:text-foreground transition-colors">
