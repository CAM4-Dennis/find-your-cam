...
const languageSlugMap: Record<string, string> = {
  ...
  Русский: "russisch-sprekend",
  "日本語": "japans-sprekend",
  "한국어": "koreaans-sprekend",
  Čeština: "tsjechisch-sprekend",
  Polski: "pools-sprekend",
  Română: "roemeens-sprekend",
  Türkçe: "turks-sprekend",
  العربية: "arabisch-sprekend",
  ไทย: "thais-sprekend",
  "中文": "chinees-sprekend",
  Hindi: "hindi-sprekend",
  Svenska: "zweeds-sprekend",
  Norsk: "noors-sprekend",
  Dansk: "deens-sprekend",
  Suomi: "fins-sprekend",
  Magyar: "hongaars-sprekend",
  Ελληνικά: "grieks-sprekend",
  "Tiếng Việt": "vietnamees-sprekend",
};
