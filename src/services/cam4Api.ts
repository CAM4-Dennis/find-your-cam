...
function normalizeCam4Model(model: Cam4Model): CamModel {
  return {
    ...
    isOnline: true,
    gender: model.gender,
    link: `https://offers.cam4tracking.com/aff_c?offer_id=278&aff_id=1961&aff_sub=startvagina&aff_sub2=${model.nickname}&url=https://www.cam4.com/${model.nickname}?showSignupPopup%26noAds=true`,
